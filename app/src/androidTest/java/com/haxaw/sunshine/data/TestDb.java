 ...
 */
package com.haxaw.sunshine.data;
...
import com.haxaw.sunshine.data.TestUtilities;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        Cursor loc_cursor;
        loc_cursor = db.query( WeatherContract.LocationEntry.TABLE_NAME,    // Table to Query
                null,       // all columns
        ...
        loc_cursor.moveToFirst();
        assertTrue("Error: Cursor is not pointing at the first row", loc_cursor.isFirst());
        ...
        idx = loc_cursor.getColumnIndex( WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING );
        assertEquals(
                testValues.get( WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING ),
                loc_cursor.getInt( idx ));
