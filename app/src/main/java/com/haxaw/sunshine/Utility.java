...
public class Utility {
    ...
    public static int getIconResourceForWeatherCondition(int weatherId) {
        ...
        else if (weatherId >= 520 && weatherId <= 531) // Rain Shower
        {
            return R.drawable.ic_rain;
        }
        ...
        else if (weatherId >= 701 && weatherId <= 762) //  Mist, smoke, haze, sand, fog, dust
        {
    ...
    public static int getArtResourceForWeatherCondition(int weatherId) {
        // Based on weather code data found at:
        // http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
        if (weatherId >= 200 && weatherId <= 232) // Thunderstorms
        {
        ...
        else if (weatherId >= 520 && weatherId <= 531) // Rain
        {
            return R.drawable.art_rain;
        }
        else if (weatherId >= 600 && weatherId <= 622) // Snow
